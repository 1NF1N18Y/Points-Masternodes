...
*Setup instructions for a Gitian build of POINTS Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the POINTS
...
- [Building POINTS Core](#building-points-core)
...
Clone the git repositories for POINTS Core and Gitian.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/pointspay/points
...
in the POINTS Core repository under 'Fetch and create inputs' to install sources which require
...
To build POINTS Core (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#setup-and-perform-gitian-builds) in the POINTS Core repository.
...
```bash
    ...
    From https://github.com/pointspay/points
...
[points/gitian.sigs](https://github.com/pointspay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
