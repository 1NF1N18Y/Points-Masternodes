...
[Translation Process](https://github.com/pointspay/points/blob/master/doc/translation_process.md) 
...
The review process is normally fairly responsive on the POINTS Core repository, however
