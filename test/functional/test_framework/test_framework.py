...
class BitcoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--noshutdown", dest="noshutdown", default=False, action="store_true",
                          help="Don't stop pointsds after the test execution")
        ...
        parser.add_option("--pointsd-arg", dest="pointsd_extra_args", default=[], type='string', action='append',
        ...
        self.extra_args_from_options = self.options.pointsd_extra_args
    ...
    def _initialize_chain(self, extra_args=None, stderr=None):
        ...
        for i in range(self.num_nodes):
            ...
            initialize_datadir(self.options.tmpdir, i, self.chain)  # Overwrite port/rpcport in points.conf
...
class MERGEXTestFramework(BitcoinTestFramework):
    def set_points_test_params(self, num_nodes, masterodes_count, extra_args=None, fast_dip3_enforcement=False):
        ...
        self.set_points_dip8_activation(200)

        # LLMQ default test params (no need to pass -llmqtestparams)
        self.llmq_size = 3
        self.llmq_threshold = 2

        # This is nRequestTimeout in points-q-recovery thread
    ...
    def set_points_dip8_activation(self, activate_after_block):
    ...
    def set_points_llmq_test_params(self, llmq_size, llmq_threshold):
