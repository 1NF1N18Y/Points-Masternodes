...
official/supported Docker Images found at https://hub.docker.com/r/pointspay/pointsd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/pointspay/pointsd-develop/ when changing the above text**